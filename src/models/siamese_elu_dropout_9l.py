# 9-layer Siamese MLP with ELU activations and Dropout.

import torch
import torch.nn as nn


class SiameseNetwork_ELU_Dropout_9L(nn.Module):
    """
    Siamese MLP with ELU + Dropout.
    Inputs:  x (B, input_size)
    Outputs: embeddings (B, 64)
    """

    def __init__(self, input_size=200, dropout_prob=0.3):
        super(SiameseNetwork_ELU_Dropout_9L, self).__init__()
        layers = []
