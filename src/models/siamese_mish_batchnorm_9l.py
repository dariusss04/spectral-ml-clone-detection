# 9-layer Siamese MLP with Mish + BatchNorm.

import torch
import torch.nn as nn


class SiameseNetwork_Mish_BatchNorm_9L(nn.Module):
    """
    Siamese MLP with Mish + BatchNorm.
    Inputs:  x (B, input_size)
    Outputs: embeddings (B, 64)
    """

    def __init__(self, input_size=200):
        super(SiameseNetwork_Mish_BatchNorm_9L, self).__init__()
        layers = []
