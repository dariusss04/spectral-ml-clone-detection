# Train self-attention model using eigenvalues only.
...
EXPERIMENT_DIR = EXPERIMENTS_DIR / "self_attention_eigen_only"
...
def train_and_evaluate_model() -> None:
    model = DeepSetSelfAttentionEigenOnly(
        input_dim=1,
        hidden_dim=64,
        output_dim=64,
        phi_layers=20,
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        with torch.no_grad():
            for pair, labels in val_loader:
                ...
                val_out1, val_out2 = model(eig1, eig2)
