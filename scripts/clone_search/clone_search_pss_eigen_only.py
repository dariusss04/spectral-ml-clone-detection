# Clone search using PSS on eigenvalues only.
...
RESULTS_FILE = RESULTS_DIR / "pss_eigen_only.csv"
...
def sim_eigen(features_a, features_b):
...
def clone_search_for_config(config_data, index_to_name, writer):
    ...
    for target_idx in targets:
        ...
        for repo_idx in repositories:
            ...
            similarity = sim_eigen(target_features, repo_features)
